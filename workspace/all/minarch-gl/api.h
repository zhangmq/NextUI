...
#define GFX_run_shader_pipeline PLAT_run_shader_pipeline // (src, orig, fw, fh, final_noflip, dx, dy, dw, dh, tex_w, tex_h, rotation)
...
void PLAT_run_shader_pipeline(unsigned int src_texture, unsigned int orig_texture_src,
		...
		float src_tex_w, float src_tex_h, int rotation);
